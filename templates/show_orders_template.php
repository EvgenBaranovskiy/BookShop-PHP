                        ...
                        <?php if ($user->IsAdmin) { ?>
                            ...
                            <td colspan="2">
                                <form action="/order/apply/<?= $order->ID ?>" method="POST">
                                    <div class="d-flex">
                                        <select class="form-select me-2" name="new-order-status">
        ...
        <ul class="pagination">
            ...
            ?>
                <li class="page-item <?= $page_number == $i ? 'active' : '' ?>">
                    <a class="page-link" href="<?= "/order/show/" . $i ?>"><?= $i ?></a>
                </li>
            <?php } ?>
            <li class="page-item <?= $page_number == $total_page_count ? 'disabled' : '' ?>">
                <a class="page-link" href="<?= "/order/show/" . ($page_number + 1) ?>">Next</a>
            </li>
        </ul>
    </nav>
</div>
